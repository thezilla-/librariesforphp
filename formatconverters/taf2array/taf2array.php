...
{
    /**
     * @var string $_strTaf taf string
     */
    protected $_strTaf = '';

    /**
     * @var string $_strModifiedTaf modified taf
     */
    protected $_strModifiedTaf = '';

    /**
     * @var array $_arrTaf taf as array
     */
    protected $_arrTaf = array();

    /**
     * @var array $_arrReference reference array
     */
    protected $_arrReference = array();

    /**
     * @var array $_arrParsingSigns parsing signs
     */
